		...
		options: [
			{
				...
				description: 'Create or replace subject collection',
			},
			{
				name: 'Get',
				value: 'get',
				action: 'Get a collection',
				description: 'Get single subject collection',
			},
			{
				name: 'Get Character Collection',
				value: 'getCharacterCollection',
				action: 'Get a character collection',
				description: 'Get single character collection',
			},
			{
				name: 'Get Character Collections',
				value: 'getCharacterCollections',
				action: 'Get character collections',
				description: 'Get user character collections',
			},
			{
				name: 'Get Collections',
				value: 'getCollections',
				action: 'Get collections',
				description: 'Get user subject collections',
			},
			{
				name: 'Get Episode',
				value: 'getEpisode',
			...
			},
			{
				...
				value: 'getEpisodes',
				action: 'Get episodes',
				description: 'Get episode collections for subject',
			},
			{
				name: 'Get Person Collection',
				value: 'getPersonCollection',
				action: 'Get a person collection',
				description: 'Get single person collection',
			},
			{
				name: 'Get Person Collections',
				value: 'getPersonCollections',
				action: 'Get person collections',
				description: 'Get user person collections',
			},
			{
				name: 'Update',
				value: 'update',
			...
			},
			{
				...
				description: 'Update single episode status',
			},
			{
				name: 'Update Episodes',
				value: 'updateEpisodes',
				action: 'Update episodes',
				description: 'Bulk update episode status',
			},
		],
